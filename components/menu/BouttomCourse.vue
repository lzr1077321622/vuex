<template>
	<div class="box">
		...
		<el-row style='margin-top: 1.25rem;'>
			<el-table :data="CourseData" style="width: 100%" @cell-mouse-enter='clickta($event)'>
				...
				<el-table-column label="操作" width="200">
					<template slot-scope="scope">
						<el-popover placement="top-start" title="提示" width="200" trigger="hover" content="线下课暂无具体介绍,请咨询*****1245">
							<el-button @click="opendetail" slot="reference" size="small" type="primary">
								详情
								<i class="el-icon-platform-eleme el-icon--right"></i>
							</el-button>
	...
	export default {
		...
		methods: {
			...
			getCourse(page, pagesize) {
				...
				var uri = uriArr.join('&');
				var self = this;
				this.$axios.get(__Config.api.bootcourse + uri, {}).then(function(res) {
